...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 21, 2019 at 04:31 PM
...
--
ALTER TABLE `orders`
  MODIFY `orderid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=500059;
...
--
ALTER TABLE `users`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4900003;
COMMIT;
