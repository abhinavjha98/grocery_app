...
{				?>	
                  ...
                  <div class="container">
                    <div class="row">
                      ...
                      <?php 
$sqlgd = "SELECT SUM(itemprice * Mquantity) as grandtotal from orderslist WHERE orderid = :orderid";
...
?>
                      <div class="col-md-8 h4">
                        <b>Grand Total : 
                          $<?php echo htmlentities($resultgd->grandtotal);?>.00 + $5 Delivery Charges
                        </b>
                      </div>
                    </div>
                  </div>
